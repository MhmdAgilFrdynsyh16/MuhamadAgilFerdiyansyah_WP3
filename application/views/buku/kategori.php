                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('buku/hapusKategori/').$k['id'];?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul. ' '.$k['kategori'];?> ?');" class="fas fa-trash"></i>Hapus</a>
                    </td>
                    </tr>
                    <?php } ?>
            </tbody>
            ...
            <form action="<?= base_url('buku/kategori'); ?>" method="post">
                <div class="form-grooup">
                    ...
                    <div class="modal-footer">
                        <button tupe="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-ban"></i>Close</button>
