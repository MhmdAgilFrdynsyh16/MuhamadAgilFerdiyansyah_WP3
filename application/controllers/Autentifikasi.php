...
if (password_verify($password, $user['password'])) {
    ...
    public function registrasi()
    {
        ...
        //jika jida disubmit kemudian validasi form diatas tidak berjalan, maka akan tetap berada ditampilan registrasi. tapi jika disubmit kemudian validasi form diatas berjalan, maka data yang diinput akan disimpan ke dalam tabel user
        if ($this->form_validation->run() == false) {
